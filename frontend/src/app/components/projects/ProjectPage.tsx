            ...
            <div className="flex items-start justify-between px-8 py-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className="flex h-8 w-8 items-center justify-center text-sm text-gray-500 hover:text-gray-900 transition-colors"
                        ...
                        {chats.length === 0 ? (
                            ...
                            <div>
                                {filteredChats.map((chat) => (
                                    <div
                                        key={chat.id}
                                        onClick={() => { if (renamingChatId === chat.id) return; navigate(`/projects/${projectId}/assistant/chat/${chat.id}`); }}
                                        className="group flex items-center h-10 pr-8 border-b border-gray-50 hover:bg-gray-50 cursor-pointer transition-colors"
                                    >
                        ...
                        {projectReviews.length === 0 ? (
                            ...
                            <div>
                                {filteredReviews.map((review) => (
                                    <div
                                        key={review.id}
                                        onClick={() => { if (renamingReviewId === review.id) return; navigate(`/projects/${projectId}/tabular-reviews/${review.id}`); }}
                                        className="group flex items-center h-10 pr-8 border-b border-gray-50 hover:bg-gray-50 cursor-pointer transition-colors"
                                    >
