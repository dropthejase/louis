            ...
            <div className="flex-1 min-h-0 overflow-auto">
              <div className="min-w-max flex min-h-full flex-col">
                <div className="flex items-center h-8 pr-8 border-b border-gray-200 text-xs text-gray-500 font-medium shrink-0 select-none">
                  <div className={`sticky left-0 z-[60] ${CHECK_W} relative bg-white flex items-center justify-center self-stretch`}>
                    {columns.length > 0 && (
                      <input
                        type="checkbox"
                ...
                <div className="flex-1">
                  {columns.length === 0 ? (
                    <div className="flex flex-col items-start py-24 w-full max-w-xs mx-auto">
                      ...
                      <p className="text-2xl font-medium font-serif text-gray-900">Columns</p>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className={`sticky left-8 z-[60] ${NAME_COL_W} p-2 ${isChecked ? 'bg-gray-50' : 'bg-white'} group-hover:bg-gray-50`}>
                            <span className="text-sm text-gray-800 truncate block">{col.name}</span>
                          </div>
                          ...
                          <div className="flex-1 min-w-0 pr-4">
                            <span className="text-xs text-gray-500 truncate block">{col.prompt}</span>
                          </div>
                          {!readOnly && (
