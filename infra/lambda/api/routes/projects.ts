...
projectsRouter.get("/", requireAuth, async (req, res) => {
  try {
    ...
    res.status(500).json({ detail: "Failed to fetch projects" });
  }
});
...
projectsRouter.get("/:projectId", requireAuth, async (req, res) => {
  try {
    ...
    res.status(500).json({ detail: "Failed to fetch project" });
  }
});
...
projectsRouter.get("/:projectId/people", requireAuth, async (req, res) => {
  try {
    ...
    console.error("[projects] GET /:projectId/people error:", err);
    res.status(500).json({ detail: "Failed to fetch project members" });
  }
});
...
projectsRouter.patch("/:projectId", requireAuth, async (req, res) => {
  try {
    ...
    console.error("[projects] PATCH /:projectId error:", err);
...
projectsRouter.get("/:projectId/documents", requireAuth, async (req, res) => {
  try {
    ...
    console.error("[projects] GET /:projectId/documents error:", err);
    res.status(500).json({ detail: "Failed to fetch documents" });
  }
});
...
projectsRouter.post("/:projectId/documents/prepare", requireAuth, async (req, res) => {
  try {
    ...
    console.error("[projects] POST /:projectId/documents/prepare error:", err);
    res.status(500).json({ detail: "Failed to prepare document upload" });
  }
});
...
projectsRouter.post(
  ...
  async (req, res) => {
    ...
    if (doc.project_id === null) {
      ...
      console.error("[projects] POST /:projectId/documents/:documentId error:", err);
      res.status(500).json({ detail: "Failed to add document to project" });
    }
  },
);
...
projectsRouter.post("/:projectId/documents/:documentId/register", requireAuth, async (req, res) => {
  try {
    ...
    console.error("[projects] POST /:projectId/documents/:documentId/register error:", err);
    res.status(500).json({ detail: "Failed to register document" });
  }
});
...
projectsRouter.get("/:projectId/chats", requireAuth, async (req, res) => {
  try {
    ...
    console.error("[projects] GET /:projectId/chats error:", err);
...
projectsRouter.post("/:projectId/folders", requireAuth, async (req, res) => {
  try {
    ...
    console.error("[projects] POST /:projectId/folders error:", err);
    res.status(500).json({ detail: "Failed to create folder" });
  }
});
...
projectsRouter.patch(
  ...
  async (req, res) => {
    try {
      ...
      console.error("[projects] PATCH /:projectId/folders/:folderId error:", err);
      res.status(500).json({ detail: "Failed to update folder" });
    }
  },
);
...
projectsRouter.delete(
  ...
  async (req, res) => {
    try {
      ...
      console.error("[projects] DELETE /:projectId/folders/:folderId error:", err);
      res.status(500).json({ detail: "Failed to delete folder" });
    }
  },
);
...
projectsRouter.patch(
  ...
  async (req, res) => {
    try {
      ...
      console.error("[projects] PATCH /:projectId/documents/:documentId/folder error:", err);
      res.status(500).json({ detail: "Failed to move document" });
    }
  },
);
